      ...
      <div className="container-site">
        ...
        <div className="mt-12 grid items-stretch gap-6 md:grid-cols-12">
          ...
          <div className="flex flex-col gap-6 md:col-span-5">
            ...
            <div className="flex flex-1 items-center gap-4 rounded-2xl border border-amber-300 bg-amber-50 p-5 shadow-card">
              <Image
                src="/images/2023/metz-2023-medal-01.webp"
                alt="Team Bangladesh medalists with their international medals"
                width={160}
                height={160}
                className="h-20 w-20 shrink-0 rounded-xl border-2 border-amber-400 object-cover"
              />
              <div>
                <span className="rounded bg-amber-500 px-2 py-1 text-[10px] font-black uppercase text-slate-950">Historic triumph</span>
                <h3 className="mt-2 text-lg">2 International Medals</h3>
                <p className="mt-1 text-xs leading-5 text-slate-600">Validated proof of Bangladeshi vocational capability at the highest tier.</p>
              </div>
            </div>
          </div>
        </div>
