    ...
    <section id="contact" aria-labelledby="contact-title" className="scroll-mt-24 bg-brand-charcoal py-20 text-white lg:py-28">
      <div className="container-site">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <a href="https://partners.epyra.agency" target="_blank" rel="noreferrer" className="mt-6 inline-flex rounded-full bg-brand-green px-8 py-3.5 text-sm font-black uppercase tracking-wider text-white">Become a Partner ↗</a>
        </div>
